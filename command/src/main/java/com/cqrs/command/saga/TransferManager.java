...
import com.cqrs.events.transfer.CompletedCancelTransferEvent;
import com.cqrs.events.transfer.CompletedCompensationCancelEvent;
...
public class TransferManager {
  ...
  protected void on(MoneyTransferEvent event) {
    ...
    comamndFactory = event.getCommandFactory();
